...
class EditUserInfo extends Component {
    constructor(props, context) {
        ...
        apiGetUserInfo_v1(["getUserInfo"], userInfoGet).then((result) => {
            ...
            const contributeSurvey = !additionalInfo ? null : !additionalInfo.contributeSurvey ? true : define(additionalInfo.contributeSurvey);
            const grownUpChildren = !additionalInfo ? null : !additionalInfo.grownUpChildren ? false : define(additionalInfo.grownUpChildren);
            const smallChildren = !additionalInfo ? null : !additionalInfo.smallChildren ? false : define(additionalInfo.smallChildren);
    ...
    handleSubmitAditionalInfo = async () => {
        ...
        await editUserAdditionalInfo(
            this.state.newMaritalStatus,
            this.state.newNumKids,
            this.state.newOccupation,
            this.state.newScholarity,
            this.state.newTeamSupport,
            this.state.newMusicStyle,
            this.state.newHobbie,
            this.state.newFavColor,
            this.state.newChannel,
            this.state.newArtist,
            this.state.hasCar,
            this.state.contributeSurvey,
            this.state.grownUpChildren,
            this.state.smallChildren
        );
        this.setState({
            open: true,
            loaded2: true,
            ...
            favColor: this.state.newFavColor,
            ...
            grownUpChildren: this.state.grownUpChildren,
            smallChildren: this.state.smallChildren
        });
    }
